...
def get_backlinks(client, page):
    ...
    for backlink in backlinks:
        ...
        edge_items.append(
            [page.title, backlink_page.title, page.get_browseable_url(), backlink_url]
        )
    return edge_items
...
def get_ref_links(client, page):
    ...
    for ref in refs:
        ...
        edge_items.append(
            [ref_page.title, page.title, ref_url, page.get_browseable_url()]
        )
    return edge_items
...
@click.option(
    "--all_nodes/--linked_nodes",
    default=False,
    help="Output all nodes or only linked nodes",
)
@click.option("--backlinks/--no_backlinks", default=False, help="Output backlink nodes")
@click.option(
    "--zotero_refs/--no_zotero_refs", default=False, help="Output zotero ref nodes"
)
